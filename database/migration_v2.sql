-- Migration v2: sezoane arhivate, exporturi PDF, setări Redis/WS
...
CREATE INDEX idx_season_archives_label ON season_archives(season_label);
CREATE INDEX idx_season_archives_date ON season_archives(archived_at DESC);
...
CREATE INDEX idx_export_files_type ON export_files(export_type);
CREATE INDEX idx_export_files_date ON export_files(created_at DESC);
